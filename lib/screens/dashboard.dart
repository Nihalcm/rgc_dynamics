    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance.collection("Task").orderBy('date',descending: true).snapshots(),
            builder: (context, snapshot) {
              int totalNewTasks = snapshot.data!.docs.where((doc) => doc['new'] == true).length;
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            FirebaseFirestore.instance.collection('Task').doc(data.id).update({
                              "new":false
                            });
                            Navigator.push(
                                context,
